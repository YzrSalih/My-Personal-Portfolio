...
import codezyLogoWhite from '../assets/Img/_CODEZY (2).png';

const TechMarquee = () => (
  <div className={styles.techMarquee}>
    <div className={styles.techTrack}>
      {/* Single sequence duplicated enough times for seamless scroll */}
      {Array.from({ length:4 }).map((_, seqIdx) => (
        <React.Fragment key={seqIdx}>
          ...
          <div className={`${styles.techIcon} ${styles.html}`}>{/* HTML */}<svg viewBox="0 0 128 128" aria-hidden="true"><defs><linearGradient id={`htmlGrad_${seqIdx}`} x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#E44D26"/><stop offset="100%" stopColor="#F16529"/></linearGradient></defs><path fill={`url(#htmlGrad_${seqIdx})`} d="M19 0h90l-8.1 92L64 128 27.2 92z"/><path fill="#EBEBEB" d="M64 52H49.2l-1-11H64V30H36l.3 3.4 3 33.6H64zM64 88.7l-.1.1-12.5-3.4-.8-9.3H40.3l1.5 18.3L64 104z"/><path fill="#fff" d="M63.9 52v11h13.7l-1.3 14.3-12.4 3.4v12l22.7-6.3.2-2.2 2.6-30.2.3-3.6H63.9zM63.9 30v11h27.9l.2-2.5.5-5.1.3-3.4z"/></svg></div>
